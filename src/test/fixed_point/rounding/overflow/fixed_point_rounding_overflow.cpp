...
namespace test_literals_initialization {
    ...
    static_assert(identical(cnl::scaled_integer<int, 0>{1}, cnl::scaled_integer(1_c)));
    static_assert(identical(cnl::scaled_integer<int, 1>{2}, cnl::scaled_integer(2_c)));
    static_assert(identical(cnl::scaled_integer<int, 0>{3}, cnl::scaled_integer(3_c)));
    static_assert(identical(cnl::scaled_integer<int, 2>{500}, cnl::scaled_integer(500_c)));
    static_assert(identical(cnl::scaled_integer<int32_t, 32>{INT64_C(0x7fffffff00000000)}, cnl::scaled_integer(0x7fffffff00000000_c)));
}

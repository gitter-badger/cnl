...
namespace cnl {
    ...
    namespace _impl {
        namespace fp {
            ...
            constexpr inline scaled_integer<Rep, Exponent> evaluate_polynomial(
            ...
            template<class Rep, int Exponent>
            inline constexpr auto exp2m1_0to1(scaled_integer<Rep, Exponent>)
            ...
            template<class Rep, int Exponent>
            constexpr inline auto exp2m1_0to1(scaled_integer<Rep, Exponent> x)
            -> _impl::enable_if_t<(Exponent<0), make_largest_ufraction<scaled_integer<Rep, Exponent>>> {
            ...
            constexpr enable_if_t<-digits<Rep>::value<Exponent, scaled_integer<Rep, Exponent, Radix>>
    ...
    template<class Rep, int Exponent>
    constexpr scaled_integer<Rep, Exponent> exp2(scaled_integer<Rep, Exponent> x) {
